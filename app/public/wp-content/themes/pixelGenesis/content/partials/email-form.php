...
<form action="https://pixelandpapers.us4.list-manage.com/subscribe/post?u=e21acaf2745039cda5b1de256&amp;id=d88b200ae6" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
	...
	<br>
    <h3 class="signup-title-desktop" style="padding: 10px;">Sign Up For Our Email List And You'll Receive Our Top Tips And Tricks For AB Testing!</h3>
...
<option selected value="2">Subscribers</option>
    ...
    <div class="clear"><input style="background-color: #36c1d4; " type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="button"></div>
    </div>
</form>
</div>
<!--End mc_embed_signup-->